...
//            }
    ...
    public TransactionResponse statement(
        ...
        DecodeTokenObject tokenObject = new DecodeTokenObject();
        try {
         tokenObject = decodeTokenV2.peekFromHeader(header);
            logger.info(tokenObject);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }

        return statementService.getStatementV1(tokenObject.getUserId() , method , size);
    }
...
//            }
    ...
    public ListAccountRes listTDAccount(
        ...
        return statementService.getTDAccount(tokenObject ,req.getPhone() );
    }
...
//            }
    ...
    public ListAccountRes listCurrentAccount(
        ...
        return statementService.getCurrentAccount(tokenObject ,req.getPhone() );
    }
...
//            }
    ...
    public PortfolioRes portfolio (Authentication authentication ,   @RequestHeader(value = "Authorization", required = false) String header ){
        ...
        return  statementService.getPortfolio(tokenObject.getUserId());
    }
